            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Edt Consultation #<?php echo $consultation->id ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-type" name="type" class="form-control"
                                               value="<?php echo $consultation->type ?>"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-date" name="date"
                                               ...
                                               value="<?php echo $consultation->date ?>"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-appointment" name="appointment"
                                               class="form-control datepicker"
                                               value="<?php echo $consultation->appointment ?>"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="input-price" name="price"
                                               class="form-control"
                                               value="<?php echo $consultation->price ?>"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="input-description"
                                                  name="description"
                                                  rows="3"><?php echo $consultation->description ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
